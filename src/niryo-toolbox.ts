...
// Declare all new blocks, used to control the Niryo One robot.
...
// Create a copy of the default toolbox and add a new category
// 'Niryo One', where we add all the newly created blocks.

export const NEW_TOOLBOX = JSON.parse(JSON.stringify(TOOLBOX));
let i = -1;
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_move_joints';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_move_pose';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_shift_pose';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_set_arm_max_speed';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_calibrate_auto';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_calibrate_manual';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_activate_learning_mode';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_joint';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_move_joint_from_joint';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_move_pose_from_pose';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_pose';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_move_pose_from_pose';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_pick_from_pose';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_place_from_pose';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_gpio_select';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_set_pin_mode';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_digital_write';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_digital_read';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_gpio_state';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_sw_select';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_set_12v_switch';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_tool_select';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_change_tool';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_detach_tool';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_open_gripper';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_close_gripper';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_pull_air_vacuum_pump';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_push_air_vacuum_pump';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_setup_electromagnet';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_activate_electromagnet';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_deactivate_electromagnet';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_sleep';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_comment';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_break_point';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_vision_color';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_vision_shape';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_vision_pick';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] =
  'niryo_one_vision_is_object_detected';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_conveyor_models';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_conveyor_use';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_conveyor_control';
NEW_TOOLBOX['categoryToolbox']['Niyro One'][++i] = 'niryo_one_conveyor_stop';
